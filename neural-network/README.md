...
- [neural_network.m](./neural_network.m) - function that initialize the neural network and starts its training.
...
- [predict.m](./predict.m) - performs prediction of the input data using trained network parameters.
